...
using Lykke.Service.NotificationSystemBroker.DomainServices.RabbitPublishers;
using Lykke.Service.NotificationSystemBroker.DomainServices.RabbitSubscribers;
using Lykke.Service.NotificationSystemBroker.Settings;
using Lykke.SettingsReader;

namespace Lykke.Service.NotificationSystemBroker.Modules
{
    [UsedImplicitly]
